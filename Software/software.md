...
This extension was made by [Daniel Sitnik](https://github.com/danielsitnik/). I modified some of the names of the variables just to match the syntax for terminus. You will probably need to modify the URL provided by the template. You will need to set your prefered temperature units and location using longitude and latitude. You can install this extension just by navigating to the extension section and clicking the import extension button (highlighted in the screenshot).
