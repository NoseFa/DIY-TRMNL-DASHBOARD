...
Even though the self-hosted setup will work I might still move onto the hosted solution just for the plugins. As I said before the plugins are really important for this device and without the support for them I don't feel like the maximum potential is reached. The extensions in Terminus do get close but still aren't perfect. I hope they can get the importing and exporting working soon. So as a suggestion if you have the money I would buy access to the TRMNL hosted servers just for the ease of use and the ecosystem around the hosted environtment. Still I have attached my current main screen on my TRMNL incase you do end up self-hosting and want a simple calendar.
